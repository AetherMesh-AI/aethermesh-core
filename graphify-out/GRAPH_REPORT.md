...
## Corpus Check
- 138 files · ~183,727 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2254 nodes · 6051 edges · 101 communities (89 shown, 12 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 399 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0dcd7396`
...
Cohesion: 0.12
Nodes (18): AetherMesh Core local prototype package., Contribution ledger helpers for local job results., MessageDelivery, Synchronous in-memory message bus for local AetherMesh simulation., A message accepted by the local bus with its deterministic sequence., JSON-backed local message log persistence for batch simulations., Local mesh message envelopes for deterministic simulation output., _require_non_empty_string() (+10 more)
...
Cohesion: 0.09
Nodes (23): run_demo(), ContributionLedger, ContributionRecord, LedgerPersistenceError, load_existing_ledger_document(), load_ledger_document(), Small in-memory ledger for prototype contribution accounting., Audit record derived from one local job result. (+15 more)

### Community 57 - "Community 57"
Cohesion: 0.15
Nodes (16): _log_ephemeral_identity_active(), _mark_ephemeral_artifact(), _mark_ephemeral_message_log(), _node_artifact_filename(), _node_artifact_path(), Command-line interface for the local AetherMesh prototype., Return a deterministic, non-merging filename for one manifest node id., Load an existing ledger and return read-only aggregate totals. (+8 more)

### Community 58 - "release_update.py"
Cohesion: 0.10
Nodes (23): Serialize the record into a JSON-compatible dictionary., Serialize the result into a JSON-compatible dictionary., _config_api_host(), _config_api_port(), _config_enabled_work_types(), _config_identity_path(), _config_identity_persistence_enabled(), _config_node_id() (+15 more)
...
Cohesion: 0.24
Nodes (4): Assignment-only local dispatch for manifest-backed batches., Deterministic local node registry for simulation roster state., _normalize_capabilities(), Deterministic local scheduler for the AetherMesh prototype.
...
Cohesion: 0.09
Nodes (13): _backup_identity_referenced_artifacts(), _identity_reset_warning(), IdentityResetResult, _load_identity_reset_receipts(), _local_identity_ref_path(), Local audit details for an explicit identity reset., Return JSON-serializable reset details for CLI/API callers., Explicitly replace a persisted local identity after quarantining the old one. (+5 more)
...
## Knowledge Gaps
- **268 isolated node(s):** `name`, `version`, `private`, `main`, `{ spawnSync }` (+263 more)
...
- **Why does `Job` connect `Community 3` to `Community 0`, `Community 98`, `Community 36`, `Community 5`, `Community 103`, `Community 71`, `Community 47`, `Community 16`, `models.py`, `Community 53`, `Community 22`, `Community 24`, `Community 57`, `Community 56`, `Community 30`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `MeshMessage` connect `Community 89` to `Community 1`, `Community 2`, `Community 98`, `Community 5`, `Community 103`, `Community 8`, `Community 43`, `Community 14`, `models.py`, `Community 16`, `Community 22`, `Community 24`, `Community 25`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 8` to `Community 1`, `Community 34`, `Community 35`, `Community 2`, `Community 103`, `Community 10`, `Community 44`, `Community 45`, `Community 14`, `Community 47`, `Community 50`, `Community 24`, `Community 57`, `Community 56`, `Community 92`, `Community 30`?**
