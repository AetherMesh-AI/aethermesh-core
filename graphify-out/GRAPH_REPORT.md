...
## Corpus Check
- 136 files · ~180,677 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2195 nodes · 5914 edges · 99 communities (85 shown, 14 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 399 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe2c936e`
...
Cohesion: 0.12
Nodes (15): dispatch_local_batch_command(), dispatch_peer_batch_command(), _mark_ephemeral_message_log(), Dispatch a manifest batch to a local message log without execution., Dispatch manifest jobs to heartbeat-derived peers without execution., Load an existing ledger and return read-only aggregate totals., _require_int_result_field(), _run_local_flow_with_roster() (+7 more)
...
Cohesion: 0.12
Nodes (14): InboxReplayRequest, dispatch_local_batch(), LocalDispatchResult, _node_heartbeat_payloads(), Structured result for local assignment-only dispatch., Serialize a deterministic, intentionally small CLI summary., Build a local dispatch log with heartbeats and job assignments only.      This f, _coerce_node() (+6 more)
...
Cohesion: 0.21
Nodes (8): ProcessedAssignment, Deterministic audit data for one inbox assignment processed locally., build_receipt_document(), Write a receipt document via temp-file then atomic replace., Build a deterministic version 1 receipt document.      Receipts are derived from, write_receipt_document(), _processed_assignment(), ReceiptTests

### Community 29 - "Community 29"
Cohesion: 0.18
Nodes (8): _coerce_job(), NoAvailableNodesError, _normalize_capabilities(), Deterministic local scheduler for the AetherMesh prototype., Raised when local job assignment has jobs but no available nodes., Minimal scheduler view of a job., Assign jobs to available capable nodes with deterministic fair ordering., ScheduledJob
...
Cohesion: 0.10
Nodes (22): _log_ephemeral_identity_active(), _node_artifact_filename(), _node_artifact_path(), Command-line interface for the local AetherMesh prototype., Return a deterministic, non-merging filename for one manifest node id., _use_ephemeral_identity(), Assignment-only local dispatch for manifest-backed batches., AetherMesh Core local prototype package. (+14 more)
...
Cohesion: 0.06
Nodes (32): _mark_ephemeral_artifact(), run_demo(), _accounted_units(), ContributionLedger, ContributionRecord, ContributionSummary, LedgerPersistenceError, load_existing_ledger_document() (+24 more)
...
- **Why does `main()` connect `Community 8` to `Community 1`, `Community 34`, `Community 35`, `Community 2`, `Community 6`, `Community 10`, `Community 44`, `Community 45`, `Community 46`, `Community 14`, `models.py`, `Community 47`, `Community 50`, `Community 24`, `Community 25`, `Community 56`, `Community 92`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Job` connect `Community 24` to `Community 0`, `Community 66`, `Community 3`, `Community 5`, `Community 6`, `Community 71`, `Community 75`, `Community 46`, `Community 47`, `Community 16`, `models.py`, `Community 53`, `Community 22`, `Community 56`, `Community 28`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `NodeIdentity` connect `Community 0` to `Community 32`, `Community 98`, `Community 66`, `Community 37`, `Community 71`, `Community 73`, `Community 43`, `Community 28`, `Community 46`, `models.py`, `Community 53`, `Community 22`, `Community 54`, `Community 56`, `Community 24`, `release_update.py`, `Community 27`, `Community 92`?**
