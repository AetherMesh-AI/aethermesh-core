...
## Corpus Check
- 136 files · ~181,517 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2205 nodes · 5958 edges · 100 communities (86 shown, 14 thin omitted)
...
Cohesion: 0.12
Nodes (15): Return capped integer contribution units for one validated local result.      Th, score_validated_contribution(), Job, JobResult, A small in-memory job assigned to a local node., Structured result emitted after local job execution., build_text_stats_output(), Build deterministic text statistics for a local ``text_stats`` job. (+7 more)
...
Cohesion: 0.18
Nodes (27): CapabilityRecordError, Validation for the local-only version 1 capability record contract., _reject_unknown_fields(), _require_attribution(), _require_capability_version(), _require_identifier(), _require_identifier_list(), _require_identifier_value() (+19 more)
...
Cohesion: 0.25
Nodes (4): Raised when a local capability record is incomplete or dishonest., Validate and return one local-only capability record without writing it.      A, validate_capability_record(), CapabilityRecordTests

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (15): _log_ephemeral_identity_active(), _node_artifact_filename(), _node_artifact_path(), Command-line interface for the local AetherMesh prototype., Return a deterministic, non-merging filename for one manifest node id., _use_ephemeral_identity(), Assignment-only local dispatch for manifest-backed batches., JSON-backed local message log persistence for batch simulations. (+7 more)
...
Cohesion: 0.11
Nodes (29): _require_int_result_field(), _run_local_flow_with_roster(), ProcessedAssignment, Deterministic audit data for one inbox assignment processed locally., build_receipt_document(), _json_compatible_dict(), _json_compatible_list(), _json_compatible_value() (+21 more)
...
Cohesion: 0.09
Nodes (9): _default_goos(), _identity_document(), load_or_create_identity(), Load a versioned local node identity, creating one if the file is missing., _run_command(), _save_identity(), HostnameReader, IdentityPersistenceTests (+1 more)
...
Cohesion: 0.11
Nodes (24): _contains_secret_identity_fragment(), _identity_artifact_has_identity_metadata(), _identity_artifact_mentions_node(), _identity_document_creator_node_id(), IdentityPersistenceError, _load_identity(), _load_identity_document(), _load_local_identity_ref_document_if_exists() (+16 more)
...
Cohesion: 0.05
Nodes (36): _mark_ephemeral_artifact(), Load an existing ledger and return read-only aggregate totals., run_demo(), summarize_ledger(), ContributionLedger, ContributionRecord, ContributionSummary, LedgerPersistenceError (+28 more)

### Community 57 - "Community 57"
Cohesion: 0.09
Nodes (22): _emitted_messages_from_inbox_result(), _inbox_process_result_to_dict(), InboxReplayRequest, _mark_ephemeral_message_log(), _node_ids_from_replayed_messages(), process_local_inbox(), Replay a saved local message log or local transport inbox for one node., Replay saved local messages and return payload plus structured result. (+14 more)
...
- **Why does `Job` connect `Community 3` to `Community 32`, `Community 0`, `Community 5`, `Community 6`, `Community 71`, `Community 75`, `Community 47`, `Community 16`, `models.py`, `Community 53`, `Community 22`, `Community 24`, `Community 57`, `Community 56`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 8` to `Community 1`, `Community 34`, `Community 35`, `Community 2`, `Community 6`, `Community 10`, `Community 44`, `Community 45`, `Community 14`, `Community 47`, `Community 46`, `Community 50`, `Community 25`, `Community 24`, `Community 57`, `Community 56`, `Community 92`, `Community 30`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `NodeIdentity` connect `Community 0` to `Community 32`, `Community 98`, `Community 3`, `Community 37`, `Community 71`, `Community 73`, `models.py`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `release_update.py`, `Community 27`, `Community 92`, `Community 24`?**
