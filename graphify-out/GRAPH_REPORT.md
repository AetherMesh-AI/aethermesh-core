...
## Corpus Check
- 136 files · ~181,153 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2201 nodes · 5932 edges · 108 communities (92 shown, 16 thin omitted)
...
Cohesion: 0.14
Nodes (7): NodeIdentity, Identity for one local node., LocalRunner, Execute supported local job types for a node., Filesystem paths used by one local AetherMesh runtime., RuntimePaths, LocalRunnerTests
...
Cohesion: 0.12
Nodes (29): collect_local_outboxes(), _load_inbox_document(), load_local_inbox(), _load_outbox_document(), local_inbox_path(), local_outbox_path(), LocalTransportError, _message_from_outbox_entry() (+21 more)
...
Cohesion: 0.19
Nodes (25): CapabilityRecordError, Validation for the local-only version 1 capability record contract., Raised when a local capability record is incomplete or dishonest., _reject_unknown_fields(), _require_attribution(), _require_identifier(), _require_identifier_list(), _require_identifier_value() (+17 more)
...
Cohesion: 0.19
Nodes (6): Assignment-only local dispatch for manifest-backed batches., JSON-backed local message log persistence for batch simulations., Deterministic local node registry for simulation roster state., Read-only local peer roster derived from heartbeat messages., Deterministic local scheduler for the AetherMesh prototype., Local multi-node simulation for the AetherMesh prototype.
...
Cohesion: 0.07
Nodes (46): _mark_ephemeral_message_log(), _require_int_result_field(), _run_local_flow_with_roster(), ProcessedAssignment, Deterministic audit data for one inbox assignment processed locally., build_receipt_document(), _json_compatible_dict(), _json_compatible_list() (+38 more)
...
Cohesion: 0.18
Nodes (9): AetherMesh Core local prototype package., Contribution ledger helpers for local job results., Synchronous in-memory message bus for local AetherMesh simulation., Local mesh message envelopes for deterministic simulation output., Core data models for the local AetherMesh prototype., Local-only node inbox processing service for assigned work messages., Canonical SHA-256 hashing for accounted local job results., Local in-memory runner for the first AetherMesh executable slice. (+1 more)
...
Cohesion: 0.13
Nodes (13): NodeRuntimeService, Raised when local runtime state cannot be safely loaded or written., Raised when a requested local validation receipt is not stored., Run a queued local submission; this is not a daemon or remote boundary., Central service for local node config, lifecycle status, peers, and jobs., Return read-only, redacted summaries of locally registered experts., Return local job buckets without faking work., Read one submission and its optional local execution evidence. (+5 more)
...
Cohesion: 0.29
Nodes (4): _ephemeral_roster(), run_demo(), Create a caller-usable ephemeral identity for local demo runs., NodeIdentityTests
...
Cohesion: 0.20
Nodes (8): _log_ephemeral_identity_active(), _mark_ephemeral_artifact(), _node_artifact_filename(), _node_artifact_path(), _node_ids_from_replayed_messages(), Command-line interface for the local AetherMesh prototype., Return a deterministic, non-merging filename for one manifest node id., _use_ephemeral_identity()
...
- **Why does `Job` connect `Community 3` to `Community 32`, `Community 0`, `Community 66`, `Community 5`, `Community 6`, `Community 73`, `Community 75`, `Community 46`, `Community 47`, `models.py`, `Community 16`, `Community 53`, `Community 22`, `Community 56`, `Community 24`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `NodeIdentity` connect `Community 0` to `Community 32`, `Community 98`, `Community 66`, `Community 37`, `Community 73`, `Community 43`, `Community 46`, `models.py`, `Community 53`, `Community 54`, `Community 56`, `Community 24`, `release_update.py`, `Community 27`, `Community 92`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 8` to `Community 1`, `Community 34`, `Community 35`, `Community 2`, `Community 6`, `Community 73`, `Community 10`, `Community 44`, `Community 76`, `Community 14`, `Community 47`, `Community 45`, `Community 50`, `Community 56`, `Community 24`, `Community 92`, `Community 25`, `Community 95`?**
