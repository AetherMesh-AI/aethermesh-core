...
## Corpus Check
- 127 files · ~171,259 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2083 nodes · 5440 edges · 91 communities (78 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 292 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a6675e2a`
...
Cohesion: 0.15
Nodes (12): Job, JobResult, A small in-memory job assigned to a local node., Structured result emitted after local job execution., _validation_summary(), _invalid(), Local validation gate for reported AetherMesh job results., Deterministic outcome from validating one reported job result. (+4 more)
...
Cohesion: 0.09
Nodes (12): AetherMesh Core local prototype package., _accounted_units(), Contribution ledger helpers for local job results., Record one result and return its local contribution record.          Only comple, _remove_temp_file(), _string_output(), Core data models for the local AetherMesh prototype., Create a caller-usable ephemeral identity for local demo runs. (+4 more)
...
Cohesion: 0.05
Nodes (60): dispatch_local_batch_command(), _emitted_messages_from_inbox_result(), _ephemeral_roster(), _inbox_process_result_to_dict(), InboxReplayRequest, _log_ephemeral_identity_active(), _mark_ephemeral_artifact(), _mark_ephemeral_message_log() (+52 more)
...
Cohesion: 0.10
Nodes (14): NodeRegistry, Deterministic local node registry for simulation roster state., In-memory source of truth for local simulation node state.      The registry is, Register a node ID or ScheduledNode in deterministic insertion order., Mark a known node available for future scheduler exports., Mark a known node offline for future scheduler exports., Record one deterministic local heartbeat for a known node., Return scheduler-compatible nodes in registration order. (+6 more)

### Community 20 - "Community 20"
Cohesion: 0.10
Nodes (26): _config_api_host(), _config_api_port(), _config_enabled_work_types(), _config_identity_path(), _config_identity_persistence_enabled(), _config_node_id(), _config_node_name(), _default_home() (+18 more)

### Community 21 - "Community 21"
Cohesion: 0.25
Nodes (9): _message_from_inbox_entry(), _message_from_document_entry(), message_from_mapping(), Local mesh message envelopes for deterministic simulation output., Build a validated MeshMessage from a JSON-like mapping., _require_non_empty_string(), _require_supported_message_type(), _validate_json_compatible() (+1 more)

### Community 22 - "Community 22"
Cohesion: 0.17
Nodes (8): _coerce_node(), LocalScheduler, _normalize_capabilities(), Deterministic local scheduler for the AetherMesh prototype., Local scheduler view of a node., In-memory deterministic scheduler for local prototype jobs., ScheduledNode, LocalSchedulerTests

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (41): ArgumentParser, ModuleType, RuntimeError, build_parser(), format_duration(), format_progress_line(), main(), max_non_killed_for_score() (+33 more)

### Community 24 - "Community 24"
Cohesion: 0.19
Nodes (5): Run the fixed local simulation demo used by the CLI command., run_default_local_simulation(), Run local jobs across local node identities using scheduler assignment.      Thi, run_local_simulation(), LocalSimulationTests
...
Cohesion: 0.11
Nodes (18): _canonical_root_json(), _component_hashes(), deterministic_machine_node_id(), HardwareComponentHashes, _index_from_hash(), _node_name_from_hashes(), _node_name_wordlist_dir(), _node_name_wordlists() (+10 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (10): JobAssignment, NoAvailableNodesError, Raised when local job assignment has jobs but no available nodes., Structured local assignment of one job to one node., Serialize the assignment into a JSON-compatible dictionary., Assign jobs to available capable nodes with deterministic fair ordering., LocalSimulationResult, _node_roster_entry() (+2 more)

### Community 29 - "Community 29"
Cohesion: 0.16
Nodes (10): dispatch_peer_batch_command(), Dispatch manifest jobs to heartbeat-derived peers without execution., dispatch_local_batch(), LocalDispatchResult, _node_heartbeat_payloads(), Assignment-only local dispatch for manifest-backed batches., Structured result for local assignment-only dispatch., Serialize a deterministic, intentionally small CLI summary. (+2 more)
...
Cohesion: 0.08
Nodes (32): build_receipt_document(), load_receipt_document_if_exists(), Deterministic local work receipt documents for processed jobs., Write a receipt document via temp-file then atomic replace., Raised when a local receipt document cannot be safely loaded or saved., Return validated metadata documents keyed by their stable reference., Build a deterministic version 1 receipt document.      Receipts are derived from, Load an existing receipt document, returning ``None`` for a missing file. (+24 more)
...
Cohesion: 0.16
Nodes (9): _configured_path(), _contains_runtime_artifacts(), _next_artifact_ref(), Initialize one local node runtime without external services., Return whether a config-less root contains more than empty directories., _relative_ref(), start_local_node(), Path (+1 more)
...
Cohesion: 0.08
Nodes (18): _default_goos(), deterministic_machine_node_name(), HardwareIdentityInputs, _identity_document(), _load_identity(), _load_identity_document(), load_or_create_identity(), Load a versioned local node identity, creating one if the file is missing. (+10 more)
...
Cohesion: 0.11
Nodes (23): _contains_secret_identity_fragment(), _create_identity_document_without_overwrite(), _identity_artifact_has_identity_metadata(), _identity_artifact_mentions_node(), _identity_document_creator_node_id(), IdentityPersistenceError, _manifest_document_matches_node(), parse_local_node_identity_document() (+15 more)
...
Cohesion: 0.14
Nodes (13): _fallback_job_id(), _job_from_assignment_payload(), LocalNodeService, ProcessedAssignment, Deterministic audit data for one inbox assignment processed locally., Synchronous local-only handler for one node's assigned-work inbox., Process unhandled ``job_assigned`` messages addressed to this node.          The, _receipt_from_processed_assignment() (+5 more)

### Community 47 - "Community 47"
Cohesion: 0.11
Nodes (32): configured_runtime_path(), configured_runtime_ref(), default_local_runtime_config(), load_local_runtime_config(), load_optional_local_runtime_config(), load_or_create_local_runtime_config(), LocalRuntimeConfig, LocalRuntimeConfigError (+24 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (20): _classify_startup_error(), _default_manifest_document(), _document_hash(), _ensure_manifest_directories(), _ensure_runtime_dirs(), _identity_creator_node_id(), _load_existing_config(), _load_json_object() (+12 more)
...
Cohesion: 0.14
Nodes (20): _accepted_result(), aggregate_local_flow(), AggregationError, build_local_flow_aggregate(), _is_accepted(), Deterministic local aggregation for completed flow artifact directories., Raised when a local flow aggregate cannot be built or written safely., Build a deterministic aggregate document after auditing a flow directory. (+12 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (27): run_demo(), ContributionLedger, ContributionRecord, ContributionSummary, LedgerPersistenceError, load_existing_ledger_document(), load_ledger_document(), Serialize the summary into a JSON-compatible dictionary. (+19 more)

### Community 57 - "Community 57"
Cohesion: 0.17
Nodes (6): build_flow_message_log_document(), Build a deterministic version 1 run-level local flow message log., MeshMessage, JSON-compatible message envelope for local mesh communication records., Serialize the message into a JSON-compatible dictionary., MeshMessageTests

### Community 59 - "Community 59"
Cohesion: 0.21
Nodes (16): _cap_units(), _ceil_div(), _non_negative_int(), Deterministic contribution scoring for validated local workload results., _score_keyword_extract(), _score_text_chunk(), _score_text_embed(), _score_text_retrieve() (+8 more)
...
Cohesion: 0.29
Nodes (5): _append_identity_reset_receipt(), _identity_reset_artifact_ref(), _identity_reset_warning(), _load_identity_reset_receipts(), Return a local audit reference without leaking host-specific directories.
...
- **Why does `MeshMessage` connect `Community 57` to `Community 32`, `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 8`, `Community 12`, `Community 14`, `Community 46`, `Community 16`, `Community 18`, `Community 21`, `Community 25`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Job` connect `Community 3` to `Community 0`, `Community 32`, `Community 66`, `Community 5`, `Community 6`, `Community 13`, `Community 14`, `Community 46`, `Community 16`, `Community 28`, `Community 22`, `Community 24`, `Community 56`, `Community 60`, `Community 29`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 8` to `Community 1`, `Community 5`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 18`, `Community 24`, `Community 25`, `Community 29`, `Community 34`, `Community 35`, `Community 37`, `Community 44`, `Community 45`, `Community 49`, `Community 50`, `Community 55`, `Community 56`?**
