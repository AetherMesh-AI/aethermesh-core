...
## Summary
- 2393 nodes · 6296 edges · 114 communities (103 shown, 11 thin omitted)
...
Cohesion: 0.09
Nodes (19): _is_local_job_id(), load_job_manifest(), _load_manifest_document(), load_manifest_jobs(), LocalJobBatch, ManifestError, _parse_capabilities(), _parse_job_entry() (+11 more)
...
Cohesion: 0.07
Nodes (38): Serialize the record into a JSON-compatible dictionary., Serialize the result into a JSON-compatible dictionary., _availability(), _capability_check_payload(), _capability_manifest_id(), _capability_provenance(), _config_api_host(), _config_api_port() (+30 more)
...
Cohesion: 0.06
Nodes (14): create_app(), _lifespan(), Local FastAPI app for the AetherMesh node dashboard., Create the localhost API/dashboard app used by CLI and UI frontends., FastAPI, RuntimeError, ApiErrorTests, ApiSchemaContractTests (+6 more)
...
Cohesion: 0.12
Nodes (14): dispatch_local_batch_command(), dispatch_peer_batch_command(), Dispatch a manifest batch to a local message log without execution., Dispatch manifest jobs to heartbeat-derived peers without execution., LocalDispatchResult, Structured result for local assignment-only dispatch., Serialize a deterministic, intentionally small CLI summary., build_dispatch_message_log_document() (+6 more)
