...
```json
{
  ...
  "creator_node_id": "creator-local-example",
  "requested_capability": "work.echo",
  "capability_manifest_id": "local-capability-work-echo-v1",
  "requester_identity": {"local_requester_identity": "developer-cli"},
