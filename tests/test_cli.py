    ...
    def test_build_parser_help_snapshots_stay_stable(self) -> None:
        ...
        self.assertEqual(
            subparser_help,
            {
                ...
                "run-local-transport-flow": "usage: aethermesh-core run-local-transport-flow [-h] --manifest MANIFEST --output-dir OUTPUT_DIR options: -h, --help show this help message and exit --manifest MANIFEST Path to a version 1 local job-batch JSON manifest. --output-dir OUTPUT_DIR Directory for deterministic local transport flow artifacts.",
